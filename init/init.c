...
/*   Updated: 2023/06/22 14:46:49 by amentag          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	all->north.img = mlx_xpm_file_to_image(all->mlx, info->north, \
					&(all->z), &(all->k));
	...
	all->east.img = mlx_xpm_file_to_image(all->mlx, \
	...
	all->west.img = mlx_xpm_file_to_image(all->mlx, \
	...
	all->south.img = mlx_xpm_file_to_image(all->mlx, \
